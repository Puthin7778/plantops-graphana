...
[![smithery badge](https://smithery.ai/badge/@Puthin7778/mcp-grafana)](https://smithery.ai/server/@Puthin7778/mcp-grafana)
...
2. You have several options to install `mcp-grafana`:
   ...
   - **Installing via Smithery**
     ...
     ```bash
     npx -y @smithery/cli install @Puthin7778/mcp-grafana
     ```
   ...
   - **Build from source**: If you have a Go toolchain installed you can also build and install it from source, using the `GOBIN` environment variable
     ...
     ```bash
     GOBIN="$HOME/go/bin" go install github.com/yourusername/mcp-grafana/cmd/mcp-grafana@latest
     ```
